...
public class StarShine3 extends JComponent{
    ...
    public void paintComponent(Graphics g) {
        ...
        for (Shape star : stars) {
            ...
            g2d.setPaint(paint);
            g2d.fill(star);
            g2d.clipRect(0,0,1000,520);
            g2d.setColor(Color.PINK);
            g2d.setFont(new Font("华文新魏", 2, 66));
            g2d.drawString("橙方赢了", 170, 120);
            g2d.setFont(new Font("华文新魏", 3, 100));
            g2d.drawString("希", 580, 250);
            g2d.drawString("腊", 800, 350);
            g2d.drawString("跳", 600, 420);
            g2d.drawString("棋", 800, 500);
